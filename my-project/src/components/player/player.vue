<template>
  <div class="player" v-show="playlist.length>0">
        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-center" :class="disableCls">
              <i @click="toggglePlaying" :class="playIcon"></i>
            </div>
      ...
      <div class="mini-player" v-show="!fullScreen" @click="open">
        ...
        <div class="control">
          <ProgressCircle :radius.number="32" :percent="percent">
            <i @click.stop="toggglePlaying" class="icon-mini" :class="minIcon"></i>
          </ProgressCircle>
        </div>
    ...
    <audio @ended="end" @timeupdate="updateTime" @error="error" @play="ready" ref="audio"
